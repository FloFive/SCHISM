...
class TiffDatasetLoader(VisionDataset):
    ...
    def __init__(self, img_data=None, mask_data=None, indices=None, data_stats=None,
                 ...
                 inference_mode=False, ignore_background=True, weights=False, augmentation_params=False):
        """
        ...
        # what heming added: reading the data_augmentation dictionary parameters
        self.augmentation_params=augmentation_params
        if self.augmentation_params:
            self.aug_brightness = self.augmentation_params['brightness']
            self.aug_angle = self.augmentation_params['angle']
            self.aug_translate = self.augmentation_params['translate']
            self.aug_scale = self.augmentation_params['scale']
            self.aug_shear = self.augmentation_params['shear']
        # end for reading the data_augmentation dictionary parameters
